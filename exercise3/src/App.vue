...
.item {
  ...
  width: calc(
    (
        100% - 2 * var(--items-by-row-when-screen-is-more-than-1024px) *
          var(--item-margin)
  ...
  @media (max-width: 1024px) {
    width: calc(
      (
          100% - 2 * var(--items-by-row-when-screen-is-more-than-600px) *
            var(--item-margin)
  ...
  @media (max-width: 600px) {
    width: calc(
      (
          100% - 2 * var(--items-by-row-when-screen-is-less-than-600px) *
            var(--item-margin)
